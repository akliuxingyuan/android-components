...
fun Int.dpToFloat(displayMetrics: DisplayMetrics) =
...
fun Float.dpToPx(displayMetrics: DisplayMetrics) =
    TypedValue.applyDimension(
        TypedValue.COMPLEX_UNIT_DIP,
        this,
        displayMetrics,
...
fun Float.spToPx(displayMetrics: DisplayMetrics) =
    TypedValue.applyDimension(
 ...
 */
class AndroidDisplayUnitConverter(private val displayMetrics: DisplayMetrics) : DisplayUnitConverter {
