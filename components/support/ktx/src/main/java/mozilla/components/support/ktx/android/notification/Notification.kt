 ...
 * @param onSetupChannel A lambda in the context of the NotificationChannel that gives you the opportunity to apply any
 *   setup on the channel before gets created.
 * @param onCreateChannel A lambda in the context of the NotificationManager that gives you the opportunity to perform
 *   any operation on the [NotificationManager].
