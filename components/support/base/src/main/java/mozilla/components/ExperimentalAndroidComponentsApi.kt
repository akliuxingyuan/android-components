...
/**
 * Items annotated with [ExperimentalAndroidComponentsApi] are subject to change or else inherently more dangerous or
 * unstable.
 *
...
@RequiresOptIn(
    ...
    message =
        "This API is experimental and should only be used with caution. " + "Annotate with @OptIn to accept the risk.",
)
@Target(
