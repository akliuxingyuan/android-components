...
/**
 * Fetches a resource from the network as described by the [Request] object, and returns response body or null if the
 * request could not executed. This call is synchronous.
 *
