...
/**
 * A browser menu item that is to be used only as a placeholder for inserting web extensions in main menu. The id of the
 * web extension to be inserted has to correspond to the id of the browser menu item.
 *
