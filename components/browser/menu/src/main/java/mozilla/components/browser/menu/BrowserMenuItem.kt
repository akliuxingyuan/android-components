...
interface BrowserMenuItem {
    /**
     * Lambda expression that returns true if this item should be shown in the menu. Returns false if this item should
     * be hidden.
     */
    val visible: () -> Boolean

    /**
     * Lambda expression that returns the number of interactive elements in this menu item. For example, a simple item
     * will have 1, divider will have 0, and a composite item, like a tool bar, will have several.
     */
     ...
     */
    val isCollapsingMenuLimit: Boolean
        get() = false
