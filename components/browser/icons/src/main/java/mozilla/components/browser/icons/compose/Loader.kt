...
/**
 * Loads an icon for the given [url] (or generates one) and makes it available to the inner [IconLoaderScope].
 *
 * The loaded image will be available through the [WithIcon] composable. While the icon is still loading [Placeholder]
 * will get rendered.
 *
 * @param url The URL of the website an icon should be loaded for. Note that this is the URL of the website the icon is
 *   *for* (e.g. https://github.com) and not the URL of the icon itself (e.g. https://github.com/favicon.ico)
