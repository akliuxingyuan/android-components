...
class TargetTest {
    ...
    fun lookupInStore() {
        ...
        assertNull(Target.Tab("unknown").lookupIn(store))

        assertNull(Target.Tab("reddit").lookupIn(store))
        ...
        assertNull(Target.CustomTab("unknown").lookupIn(store))

        assertNull(Target.CustomTab("mozilla").lookupIn(store))
        ...
        assertNull(Target.SelectedTab.lookupIn(store))
    }
    ...
    fun lookupInState() {
        ...
        assertNull(Target.Tab("unknown").lookupIn(state))

        assertNull(Target.Tab("reddit").lookupIn(state))
        ...
        assertNull(Target.CustomTab("unknown").lookupIn(state))

        assertNull(Target.CustomTab("mozilla").lookupIn(state))
    }
}
