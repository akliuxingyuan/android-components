 ...
 *
 * @property isTranslationsEnabled Whether the translations feature is enabled and should be shown to the user.
 ...
 * @property languageSettings A map containing a key of BCP 47 language code and its [LanguageSetting] to represent the
 *   automatic language settings.
 * @property neverTranslateSites List of sites the user has opted to never translate.
 * @property engineError Holds the error state of the translations engine. See [TranslationsState.translationError] for
