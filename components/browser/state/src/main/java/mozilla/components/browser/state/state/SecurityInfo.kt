...
sealed class SecurityInfo {
    ...
    /**
     * Security details of the current connection are not yet known. This is the default state, transient until the
     * needed details are loaded.
     */
    ...
    companion object {
         ...
         *
         * @param isSecure true if the tab is currently pointed to a URL with a valid SSL certificate, otherwise false.
