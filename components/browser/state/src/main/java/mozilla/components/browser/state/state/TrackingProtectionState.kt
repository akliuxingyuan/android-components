 ...
 * @property loadedTrackers List of trackers that have been loaded (not blocked) for the currently loaded site.
 * @property ignoredOnTrackingProtection Whether tracking protection should be enabled or not for this [SessionState]
 */
