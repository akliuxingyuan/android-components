...
object GeckoWebContentIsolationMapper {
    ...
    /**
     * Convenience method for mapping a GeckoView [GeckoWebContentIsolationStrategy], which is an Int, to the Android
     * Components defined type of [EngineWebContentIsolationStrategy].
     *
    ...
    fun Int.intoWebContentIsolationStrategy(): EngineWebContentIsolationStrategy {
        return when (this) {
            STRATEGY_ISOLATE_NOTHING -> EngineWebContentIsolationStrategy.ISOLATE_NOTHING
            STRATEGY_ISOLATE_EVERYTHING -> EngineWebContentIsolationStrategy.ISOLATE_EVERYTHING
            STRATEGY_ISOLATE_HIGH_VALUE -> EngineWebContentIsolationStrategy.ISOLATE_HIGH_VALUE
            else -> {
    ...
    /**
     * Convenience method for mapping a Android Components defined [EngineWebContentIsolationStrategy], to the GeckoView
     * [GeckoWebContentIsolationStrategy], which is an int.
     *
    ...
    fun EngineWebContentIsolationStrategy.intoWebContentIsolationStrategy(): Int {
        return when (this) {
            EngineWebContentIsolationStrategy.ISOLATE_NOTHING -> STRATEGY_ISOLATE_NOTHING
            EngineWebContentIsolationStrategy.ISOLATE_EVERYTHING -> STRATEGY_ISOLATE_EVERYTHING
            EngineWebContentIsolationStrategy.ISOLATE_HIGH_VALUE -> STRATEGY_ISOLATE_HIGH_VALUE
        }
    }
}
