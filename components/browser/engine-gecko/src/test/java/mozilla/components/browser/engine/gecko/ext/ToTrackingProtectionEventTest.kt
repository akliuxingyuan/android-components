...
class ToTrackingProtectionEventTest {
    ...
    fun `GIVEN a gecko tracker WHEN mapping it to a tracker blocked event THEN all properties are correctly mapped`() {
        val mapping =
            mapOf(
                ContentBlockingController.TrackingDbEvent.OTHER_COOKIES_BLOCKED_ID to
                ...
                ContentBlockingController.TrackingDbEvent.TRACKING_COOKIES_ID to
                ...
                ContentBlockingController.TrackingDbEvent.SUSPICIOUS_FINGERPRINTERS_ID to
