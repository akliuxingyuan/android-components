...
private fun singleParagraph(content: List<InlineContent>): RichDocument {
    return RichDocument(blocks = listOf(Paragraph(content = content)))
}
...
private val StandaloneStrongContent =
    ParserTestCase(
...
private val StandaloneEmphasisContent =
    ParserTestCase(
...
private val StandaloneEmphasisUsingUnderscore =
    ParserTestCase(
...
private val EmphasisSurroundedByStrong =
    ParserTestCase(
        ...
        expectedDocument =
            singleParagraph(
                content =
                    listOf(
                        Plain("emphasis "),
                        Strong(children = listOf(element = Emphasis(children = listOf(Plain("surrounded"))))),
                    )
            ),
    )

private val SingleParagraphWithLineBreaks =
    ParserTestCase(
...
private val StrongSurroundedByEmphasis =
    ParserTestCase(
        ...
        expectedDocument =
            singleParagraph(
                content =
                    listOf(
                        Plain("strong "),
                        Emphasis(children = listOf(Strong(children = listOf(Plain("surrounded"))))),
                    )
            ),
    )

private val InlineCodeContent =
    ParserTestCase(
...
private val LinkWithFormatting =
    ParserTestCase(
            ...
            singleParagraph(
                content =
                    listOf(
                        InlineContent.Link(
                            url = "https://example.com",
                            children = listOf(Strong(listOf(Plain("bold link")))),
                        )
                    )
            ),
    )

private val CombinedInlineFormatting =
    ParserTestCase(
...
private val MultipleParagraphs =
    ParserTestCase(
...
private val HeadingWithFormatting =
    ParserTestCase(
                ...
                blocks =
                    listOf(
                        ListBlock(
                            ...
                            items =
                                listOf(
                                    ListItem(content = listOf(Paragraph(content = listOf(Plain("First item"))))),
                                    ListItem(content = listOf(Paragraph(content = listOf(Plain("Second item"))))),
                                    ListItem(content = listOf(Paragraph(content = listOf(Plain("Third item"))))),
                                ),
                        )
                    )
            ),
...
private val ListWithFormatting =
    ParserTestCase(
...
private val NestedUnorderedList =
    ParserTestCase(
                        ...
                        ListBlock(
                            ...
                            items =
                                listOf(
                                                        ...
                                                        listOf(
                                                            ListItem(
                                                                content =
                                                                    listOf(
                                                                        Paragraph(
                                                                            content = listOf(Plain("Nested item 1"))
                                                                        )
                                                                    )
                                                            ),
                                                            ListItem(
                                                                content =
                                                                    listOf(
                                                                        Paragraph(
                                                                            content = listOf(Plain("Nested item 2"))
                                                                        )
                                                                    )
                                                            ),
                                                        ),
                                    ...
                                    ListItem(content = listOf(Paragraph(content = listOf(Plain("Another parent"))))),
                                ),
                        )
                    )
            ),
                                                        ...
                                                        listOf(
                                                            ListItem(
                                                                content =
                                                                    listOf(
                                                                        Paragraph(
                                                                            content = listOf(Plain("Nested first"))
                                                                        )
                                                                    )
                                                            ),
                                                            ListItem(
                                                                content =
                                                                    listOf(
                                                                        Paragraph(
                                                                            content = listOf(Plain("Nested second"))
                                                                        )
                                                                    )
                                                            ),
                                                        ),
                ...
                blocks =
                    listOf(
                        ...
                        ListBlock(
                            ...
                            items =
                                listOf(
                                    ListItem(content = listOf(Paragraph(content = listOf(Plain("List item one"))))),
                                    ListItem(content = listOf(Paragraph(content = listOf(Plain("List item two"))))),
                                ),
                        ),
...
private val SimpleBlockQuote =
    ParserTestCase(
        ...
        expectedDocument =
            document(
                blocks = listOf(BlockQuote(content = listOf(Paragraph(content = listOf(Plain("This is a quote"))))))
            ),
    )

private val BlockQuoteWithMultipleParagraphs =
    ParserTestCase(
...
private val BlockQuoteWithFormatting =
    ParserTestCase(
                        ...
                        BlockQuote(
                            content =
                                listOf(
                                    ...
                                    BlockQuote(content = listOf(Paragraph(content = listOf(Plain("Inner quote"))))),
                                )
                        )
                    )
            ),
...
private val BlockQuoteWithList =
    ParserTestCase(
...
internal val ParserTestCases: List<ParserTestCase> =
    listOf(
