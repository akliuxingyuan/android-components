...
/**
 * Lints against using `androidx.compose.material3.TextButton` and instead recommends using
 * `mozilla.components.compose.base.button.TextButton` which aligns with the Acorn Design System.
 */
class MaterialTextButtonUsageRule(config: Config = Config.empty) : Rule(config) {
    override val issue: Issue
        get() =
            Issue(
                id = "MaterialTextButtonUsage",
    ...
    /**
     * Report a code smell if the fully qualified `androidx.compose.material3.TextButton` is referenced outside the
     * imports.
     */
    ...
    companion object {
        ...
        private const val FORBIDDEN_NAME = "TextButton"
        private const val FORBIDDEN_IMPORT = "$FORBIDDEN_PACKAGE.$FORBIDDEN_NAME"
        private const val RECOMMENDED_IMPORT = "mozilla.components.compose.base.button.TextButton"
