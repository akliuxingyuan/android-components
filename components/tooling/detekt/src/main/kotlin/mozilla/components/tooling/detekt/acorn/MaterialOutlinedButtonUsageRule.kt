...
/**
 * Lints against using `androidx.compose.material3.OutlinedButton` and instead recommends using
 * `mozilla.components.compose.base.button.OutlinedButton` which aligns with the Acorn Design System.
 */
class MaterialOutlinedButtonUsageRule(config: Config = Config.empty) : Rule(config) {
    override val issue: Issue
        get() = Issue(
            id = "MaterialOutlinedButtonUsage",
    ...
    /**
     * Report a code smell if the fully qualified `androidx.compose.material3.OutlinedButton` is
     * referenced outside the imports.
     */
    ...
    companion object {
        ...
        private const val FORBIDDEN_NAME = "OutlinedButton"
        private const val FORBIDDEN_IMPORT = "$FORBIDDEN_PACKAGE.$FORBIDDEN_NAME"
        private const val RECOMMENDED_IMPORT = "mozilla.components.compose.base.button.OutlinedButton"
