 ...
 *
 * @property browserActionsStart List of browser [Action]s to be displayed at the start of the toolbar, outside of the
 *   URL bounding box. These should be actions relevant to the browser as a whole. See
 *   [MDN docs](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/browserAction).
 * @property pageActionsStart List of navigation [Action]s to be displayed between [browserActionsStart] and the current
 *   webpage's details, inside of the URL bounding box. These should be actions relevant to specific webpages as opposed
 *   to [browserActionsStart]. See
 ...
 * @property pageActionsEnd List of page [Action]s to be displayed between [pageOrigin] and [browserActionsEnd], inside
 *   of the URL bounding box. These should be actions relevant to specific webpages as opposed to [browserActionsStart].
 *   See [MDN docs](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/pageAction).
 * @property browserActionsEnd List of browser [Action]s to be displayed at the end of the toolbar, outside of the URL
 ...
 * @property progressBarConfig [ProgressBarConfig] configuration for the progress bar. If `null` a progress bar will not
 *   be displayed.
 ...
 * @property queryWasPrefilled Whether a non-empty prefilled query was set at any point during the current edit session,
 *   indicating the toolbar was opened on an existing page. Reset to false when exiting edit mode.
 * @property editActionsStart List of [Action]s to be displayed at the start of the URL of the edit toolbar.
 * @property editActionsEnd List of [Action]s to be displayed at the end of the URL of the edit toolbar.
 */
 ...
 * @property color List of colors to use for the progress bar. If more are provided then the progress bar will show them
 *   as a gradient. If `null` is provided the default colors will be used.
 */
...
/**
 * Where is the toolbar positioned on the screen. Inner toolbar elements will be positioned to best support each toolbar
 * gravity.
 */
