...
object BrowserToolbarTestTags {
    ...
    /** Test tag for the title shown while in "display" mode. Webpage title is shown (if available) in custom tabs. */
    ...
    /** Test tag for the toolbar while in "edit" mode. Useful for entering text to search or an URL to load. */
