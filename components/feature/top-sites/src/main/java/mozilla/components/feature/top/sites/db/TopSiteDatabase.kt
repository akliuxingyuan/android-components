    ...
    val migration_1_2 =
        object : Migration(1, 2) {
            override fun migrate(db: SupportSQLiteDatabase) {
                ...
                db.execSQL("ALTER TABLE top_sites ADD COLUMN is_default INTEGER NOT NULL DEFAULT 0")
    ...
    val migration_2_3 =
        object : Migration(2, 3) {
            override fun migrate(db: SupportSQLiteDatabase) {
                ...
                db.execSQL("DROP TABLE top_sites")

                // Rename the temporary table to top_sites.
                db.execSQL("ALTER TABLE top_sites_temp RENAME TO top_sites")
