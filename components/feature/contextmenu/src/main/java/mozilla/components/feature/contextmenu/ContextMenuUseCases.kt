 ...
 */
class ContextMenuUseCases(store: BrowserStore) {
    class ConsumeHitResultUseCase(private val store: BrowserStore) {
    ...
    class InjectDownloadUseCase(private val store: BrowserStore) {
        /**
         * Adds a [DownloadState] to the [BrowserStore] with the given [tabId].
         *
         * This is a hacky workaround. After we have migrated everything from browser-session to browser-state we should
         * revisits this and find a better solution.
         */
    ...
    class InjectShareInternetResourceUseCase(private val store: BrowserStore) {
    ...
    class InjectCopyInternetResourceUseCase(private val store: BrowserStore) {
