...
interface AddressDelegate {
    /**
     * The [AutocompletePrompt] used for [AddressPicker] to display a a prompt with a list of address options available
     * for autocomplete.
     */
    val addressPickerView: AutocompletePrompt<Address>?

    /** Callback invoked when the user clicks "Manage addresses" from select address prompt. */
