...
@PublishedApi
internal val PROMPTS_TO_EXIT_FULLSCREEN_FOR =
...
/**
 * Convenience method for executing code if the current [PromptRequest] is one that should not be shown in fullscreen
 * tabs.
 */
internal inline fun PromptRequest.executeIfWindowedPrompt(block: () -> Unit) {
