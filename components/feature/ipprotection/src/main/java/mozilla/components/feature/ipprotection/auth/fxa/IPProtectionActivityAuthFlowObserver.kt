 ...
 *
 * N.B: This is no where close to perfect because we need to know when an authentication is complete for our specific
 * scope, but we don't have this capability today. We've tried doing this in the `FxaAccountStoreSync` but because our
 * apps have a single activity model, those observes experience an "Authentication" event immediately that resets the
 * state machine.
 *
 * See: FXA-13706
 */
