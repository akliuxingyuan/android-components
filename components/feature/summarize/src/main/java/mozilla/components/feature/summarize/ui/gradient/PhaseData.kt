...
internal object BlobAnimation {
    ...
    const val TOTAL_DURATION_MS = PHASE_1_TO_2_DURATION_MS + PHASE_2_TO_3_DURATION_MS + PHASE_3_TO_1_DURATION_MS
...
internal val LIGHT_PURPLE_BLOB =
    BlobSpec(
...
internal val DARK_PURPLE_G1_PHASES =
    BlobPhases(
...
internal val LIGHT_PURPLE_G1_PHASES =
    BlobPhases(
...
internal val DARK_PURPLE_G2_PHASES =
    BlobPhases(
        phase1 = DARK_PURPLE_G1_POSE,
...
internal val LIGHT_PURPLE_G2_PHASES =
    BlobPhases(
        phase1 = LIGHT_PURPLE_G1_POSE,
