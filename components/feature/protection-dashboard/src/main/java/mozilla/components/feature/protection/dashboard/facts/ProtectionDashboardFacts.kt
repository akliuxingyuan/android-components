...
/**
 * Emits a fact when one of the tracker breakdown categories is tapped. The tapped [category] is carried in the fact
 * value so the consuming application can map it to its own telemetry.
 */
