...
internal abstract class SitePermissionsDatabase : RoomDatabase() {
    ...
    companion object {
        @Volatile private var instance: SitePermissionsDatabase? = null
...
internal class StatusConverter {
    private val autoplayStatusArray = SitePermissions.AutoplayStatus.entries.toTypedArray()
    ...
    val migration_1_2 =
        object : Migration(1, 2) {
            override fun migrate(db: SupportSQLiteDatabase) {
                // Version 1 is used in Nightly builds of Fenix, but not in production. Let's just skip actually
                // migrating
