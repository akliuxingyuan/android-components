...
class ParserTest {
    ...
    fun `can parse a response from Google`() {
        val json =
            "[\"firefox\",[\"firefox\",\"firefox for mac\",\"firefox quantum\",\"firefox update\",\"firefox esr\",\"firefox focus\",\"firefox addons\",\"firefox extensions\",\"firefox nightly\",\"firefox clear cache\"]]"
    ...
    fun `can parse a response from Amazon`() {
        val json =
            "[\"firefox\",[\"firefox for fire tv\",\"firefox movie\",\"firefox app\",\"firefox books\",\"firefox glider\",\"firefox stick\",\"firefox for firestick\",\"firefox\",\"firefox books series\",\"firefox browser\"],[{\"nodes\":[{\"name\":\"Apps & Games\",\"alias\":\"mobile-apps\"}]},{},{},{},{},{},{},{},{},{}],[],\"344I6KZL0KU9N\"]"
        ...
        val expectedResults =
            listOf(
                ...
                "firefox glider",
                "firefox stick",
                "firefox for firestick",
                "firefox",
                "firefox books series",
                "firefox browser",
            )
        assertEquals(expectedResults, results)
    }
    ...
    fun `can parse a response from Baidu`() {
        val json =
            "[\"firefox\",[\"firefox rocket\",\"firefox手机浏览器\",\"firefox是什么意思\",\"firefox focus\",\"firefox风哥\",\"firefox官网\",\"firefox吧\",\"firefox os\",\"firefox国际版\",\"firefox android\"]]"
    ...
    fun `can parse a response from Bing`() {
        val json =
            "[\"firefox\",[\"firefox\",\"firefox download\",\"firefox for windows 10\",\"firefox browser\",\"firefox quantum\",\"firefox esr\",\"firefox 64-bit\",\"firefox mozilla\",\"firefox nightly\",\"firefox update\",\"firefox install\",\"firefox focus\",\"firefox beta\",\"firefox developer edition\",\"firefox portable\",\"firefox add-ons\"]]"
    ...
    fun `can parse a response from Coccoc`() {
        val json =
            "[\"firefox\",[\"firefox\",\"firefox tiếng việt\",\"firefox download\",\"firefox quantum\",\"firefox 51\",\"firefox 42\",\"firefox english\",\"firefox portable\",\"firefox 49\",\"firefox viet nam\"],[\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\"],[\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\"],{\"google:suggesttype\":[\"QUERY\",\"QUERY\",\"QUERY\",\"QUERY\",\"QUERY\",\"QUERY\",\"QUERY\",\"QUERY\",\"QUERY\",\"QUERY\"]}]"
    ...
    fun `can parse a response from Daum`() {
        val json =
            "{\"q\":\"firefox\",\"rq\":\"firefox\",\"items\":[\"firefox\",\"firefox download\",\"firefox focus\",\"mozilla firefox\",\"firefox adobe flash\",\"firefox 삭제\",\"firefox 한글판\",\"firefox 즐겨찾기 가져오기\",\"firefox quantum\",\"firefox 57\",\"mozila firefox\",\"mozilla firefox download\",\"mozilla firefox 삭제\",\"Hacking Firefox\",\"Programming Firefox\"],\"r_items\":[]}"
    ...
    fun `can parse a response from Duck Duck Go`() {
        val json =
            "[\"firefox\",[\"firefox\",\"firefox browser\",\"firefox.com\",\"firefox update\",\"firefox for mac\",\"firefox quantum\",\"firefox extensions\",\"firefox esr\",\"firefox clear cache\",\"firefox themes\"]]"
    ...
    fun `can parse a response from Prisjakt`() {
        ...
        val expectedResults =
            listOf(
                "Firefox",
                "Firefox",
                "Mountain Equipment Firefox Pants (Herr)",
                "Mountain Equipment Firefox (Herr)",
                "Firefox (DE)",
            )
        assertEquals(expectedResults, results)
    }
    ...
    fun `can parse a response from Qwant`() {
        val json =
            "{\"status\":\"success\",\"data\":{\"items\":[{\"value\":\"firefox (video game)\",\"suggestType\":3},{\"value\":\"firefox addons\",\"suggestType\":12},{\"value\":\"firefox\",\"suggestType\":2},{\"value\":\"firefox quantum\",\"suggestType\":12},{\"value\":\"firefox focus\",\"suggestType\":12}],\"special\":[],\"availableQwick\":[]}}"

        val results = qwantResponseParser(json)
        val expectedResults =
            listOf("firefox (video game)", "firefox addons", "firefox", "firefox quantum", "firefox focus")
        assertEquals(expectedResults, results)
    }
    ...
    fun `can parse a response from Seznam`() {
        val json =
            "[\"firefox\", [\"firefox\", \"firefox ak keep it up\", \"firefox ak city to city\", \"firefox ak all those people\", \"firefox ak who can act\", \"firefox ak color the trees\", \"firefox ak habibi\", \"firefox ak zodiac\", \"firefox ak the draft\", \"mozilla firefox\"], [], []]"

        val results = defaultResponseParser(json)
        val expectedResults =
            listOf(
                "firefox",
                "firefox ak keep it up",
    ...
    fun `can parse a response from Yandex`() {
        val json =
            "[\"firefox\",[\"firefox\",\"firefox download\",\"firefox browser\",\"firefox update\",\"firefox.com\"]]"
