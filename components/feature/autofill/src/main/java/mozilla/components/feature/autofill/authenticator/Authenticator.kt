...
internal interface Authenticator {
    /** Shows an authentication prompt and will invoke [callback] once authentication succeeded or failed. */
    ...
    interface Callback {
        /**
         * Called when a biometric (e.g. fingerprint, face, etc.) is recognized, indicating that the user has
         * successfully authenticated.
         */
        fun onAuthenticationSucceeded()

        /**
         * Called when a biometric (e.g. fingerprint, face, etc.) is presented but not recognized as belonging to the
         * user.
         */
