...
/** [Authenticator] implementation that uses [BiometricManager] and [BiometricPrompt] to authorize the user. */
internal class BiometricAuthenticator(private val configuration: AutofillConfiguration) : Authenticator {
    ...
    companion object {
        ...
        /**
         * Returns `true` if biometric authentication with [BiometricAuthenticator] is not possible yet, but the user
         * can enroll and create credentials for it.
         */
...
private class PromptCallback(private val callback: Authenticator.Callback) : BiometricPrompt.AuthenticationCallback() {
