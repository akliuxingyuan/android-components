...
interface AddonsProvider {
    ...
    /**
     * Provides a list of all featured add-ons, which are add-ons we list in the add-ons manager UI by default (e.g. the
     * add-ons that are available for the app or a set of curated add-ons).
     *
     ...
     *
     * @param id of the addon for which to get the download URL. Can be an addon's ID, GUID, or other unique identifier.
