...
fun Addon.displayName(context: Context): String =
    if (this.translatableName.isNotEmpty()) {
...
fun Addon.summary(context: Context): String? =
    if (this.translatableSummary.isNotEmpty()) {
...
val Addon.updatedAtDate: Date
    get() = dateParser.parse(updatedAt)!!
