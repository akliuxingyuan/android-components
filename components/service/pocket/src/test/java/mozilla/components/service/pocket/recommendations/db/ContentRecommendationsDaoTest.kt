...
class ContentRecommendationsDaoTest {
    ...
    fun setUp() {
        ...
        database =
            Room.inMemoryDatabaseBuilder(testContext, ContentRecommendationsDatabase::class.java)
    ...
    @Test
    fun `WHEN a content recommendation is inserted and fetched THEN the newly inserted recommendation is returned`() =
        runTest {
    ...
    @Test
    fun `WHEN a content recommendation is deleted THEN content recommendation is removed from the database`() =
        runTest {
            val recommendation1 = PocketTestResources.contentRecommendationEntity
            val recommendation2 =
                PocketTestResources.contentRecommendationEntity.copy(corpusItemId = recommendation1.corpusItemId + 2)
    ...
    fun `WHEN a content recommendation is updated and fetched THEN the updated recommendation is returned`() = runTest {
        ...
        val updatedRecommendation1 =
            recommendation1.copy(
                title = "title",
    ...
    @Test
    fun `WHEN content recommendations impressions are updated THEN content recommendations impressions are updated in the database`() =
        runTest {
            val recommendation1 = PocketTestResources.contentRecommendationEntity
            val recommendation2 =
                PocketTestResources.contentRecommendationEntity.copy(
            ...
            val updatedRecommendationImpression1 =
                ContentRecommendationImpression(
                    corpusItemId = recommendation1.corpusItemId,
                    impressions = 10,
                )
            val updatedRecommendationImpression3 =
                ContentRecommendationImpression(
    ...
    @Test
    fun `GIVEN an updated content recommendation impression is provided that is not in the storage WHEN content recommendations impressions are updated THEN no update occurs`() =
        runTest {
            val recommendation1 = PocketTestResources.contentRecommendationEntity
            val recommendation2 =
                PocketTestResources.contentRecommendationEntity.copy(
            ...
            dao.updateRecommendationsImpressions(recommendations = listOf(updatedRecommendationImpression1))
    ...
    @Test
    fun `GIVEN a new list of content recommendations WHEN the database is cleaned and updated THEN the new list of recommendation is stored`() =
        runTest {
            ...
            val recommendation2 =
                PocketTestResources.contentRecommendationEntity.copy(corpusItemId = recommendation1.corpusItemId + 2)
            val recommendation3 =
                PocketTestResources.contentRecommendationEntity.copy(corpusItemId = recommendation1.corpusItemId + 3)
    ...
    @Test
    fun `GIVEN an update to existing content recommendations WHEN the database is cleaned and updated THEN the updated recommendation is stored`() =
        runTest {
            setupDatabaseForTransactions()
            ...
            val updatedRecommendation2 =
                recommendation2.copy(
                    title = "title",
                    receivedRank = 10,
                )
    ...
    @Test
    fun `GIVEN new recommendations to the existing content recommendations WHEN the database is cleaned and updated THEN the new recommendations are stored`() =
        runTest {
            setupDatabaseForTransactions()
            ...
            val recommendation3 =
                PocketTestResources.contentRecommendationEntity.copy(corpusItemId = recommendation1.corpusItemId + 3)
            val recommendation4 =
                PocketTestResources.contentRecommendationEntity.copy(corpusItemId = recommendation1.corpusItemId + 4)
            val recommendation5 =
                PocketTestResources.contentRecommendationEntity.copy(corpusItemId = recommendation1.corpusItemId + 5)
    ...
    /**
     * Sets an executor to be used for database transactions. Needs to be used along with "runTest" to ensure waiting
     * for transactions to finish but not hang tests.
     */
