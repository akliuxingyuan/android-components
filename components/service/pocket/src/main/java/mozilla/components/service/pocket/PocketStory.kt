...
sealed class PocketStory {
     ...
     * @property callbacks The [SponsoredContentCallbacks] object containing callback URLs for click and impression
     *   tracking.
     ...
     *
     * @property currentImpressions List of all recorded impression of a sponsored content expressed in seconds from
     *   Epoch (as the result of `System.currentTimeMillis / 1000`).
     * @property flightCount Maximum number of times this sponsored content should be shown in the given [flightPeriod].
     * @property flightPeriod Period expressed as a number of seconds in which this sponsored content should be shown
     *   for at most [flightCount] times. Any time the period comes to an end the [flightCount] count should be
     *   restarted.
     */
     ...
     * @property publisher Optional publisher name/domain, e.g. "The New Yorker" / "nationalgeographic.co.uk"". **May be
     *   empty**.
     ...
     * @property imageUrl A url to a still image representing the story. Contains a "resize" parameter in the form of
     *   "resize=w618-h310" allowing to get the image with a specific resolution and the CENTER_CROP ScaleType.
     ...
     * @property priority Priority level in deciding which stories to be shown first. A lowest number means a higher
     *   priority.
     ...
     *
     * @property currentImpressions List of all recorded impression of a sponsored Pocket story expressed in seconds
     *   from Epoch (as the result of `System.currentTimeMillis / 1000`).
     * @property lifetimeCount Lifetime maximum number of times this story should be shown. This is independent from the
     *   count based on [flightCount] and [flightPeriod] and must never be reset.
     * @property flightCount Maximum number of times this story should be shown in [flightPeriod].
     * @property flightPeriod Period expressed as a number of seconds in which this story should be shown for at most
     *   [flightCount] times. Any time the period comes to an end the [flightCount] count should be restarted. Even if
     *   based on [flightCount] and [flightCount] this story can still be shown a couple more times if [lifetimeCount]
     *   was met then the story should not be shown anymore.
     */
