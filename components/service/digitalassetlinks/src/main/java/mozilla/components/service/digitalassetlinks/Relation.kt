...
enum class Relation(val kindAndDetail: String) {
    ...
    /**
     * Grants the target permission to retrieve sign-in credentials stored for the source. For App -> Web transitions,
     * requests the app to use the declared origin to be used as origin for the client app in the web APIs context.
     */
