 ...
 *
 * A digital asset is an identifiable and addressable online entity that typically provides some service or content.
 */
sealed class AssetDescriptor {
     ...
     * @sample AssetDescriptor.Web( site = "https://{fully-qualified domain}{:optional port}" )
     */
    data class Web(val site: String) : AssetDescriptor()
     ...
     * @sample AssetDescriptor.Android( packageName = "com.costingtons.app", sha256CertFingerprint =
