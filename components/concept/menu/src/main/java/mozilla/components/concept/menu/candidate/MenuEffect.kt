 ...
 */
data class LowPriorityHighlightEffect(@param:ColorInt val notificationTint: Int) : MenuIconEffect()
 ...
 */
data class HighPriorityHighlightEffect(@param:ColorInt val backgroundTint: Int) : MenuCandidateEffect()
