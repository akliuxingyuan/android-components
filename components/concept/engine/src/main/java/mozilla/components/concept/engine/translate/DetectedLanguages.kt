 ...
 *
 * @property documentLangTag The auto-detected language tag of page. Usually used for determining the best guess for
 *   translating "from".
 * @property supportedDocumentLang If the translation engine supports the document language.
 * @property userPreferredLangTag The user's preferred language tag. Usually used for determining the best guess for
 *   translating "to".
 */
