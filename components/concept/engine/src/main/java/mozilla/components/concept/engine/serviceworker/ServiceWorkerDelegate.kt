...
interface ServiceWorkerDelegate {
    /**
     * Handles requests to open a new tab using the provided [engineSession]. Implementations should not try to load any
     * url, this will be executed by the service worker through the [engineSession].
     *
