 ...
 * @property iconUrl Large icon url to display in the notification. Corresponds to
 ...
 * @property engineNotification Notification instance native to [Engine] which can be sent across processes or persisted
 *   and restored later.
 * @property timestamp Time when the notification was created.
 * @property triggeredByWebExtension True if this notification was triggered by a web extension, otherwise false.
