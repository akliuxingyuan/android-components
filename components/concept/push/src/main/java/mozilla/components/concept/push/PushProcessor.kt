...
/**
 * A push notification processor that handles registration and new messages from the [PushService] provided. Starting
 * Push in the Application's onCreate is recommended.
 */
interface PushProcessor {
    ...
    /**
     * A new push message has been received. The message contains the payload as sent by the Autopush server, and it
     * will be read at a lower abstraction layer.
     */
    ...
    companion object {
        /**
         * Initialize and installs the PushProcessor into the application. This needs to be called in the application's
         * onCreate before a push service has started.
         */
        fun install(processor: PushProcessor) {
            instance = processor
        }

        @Volatile private var instance: PushProcessor? = null
