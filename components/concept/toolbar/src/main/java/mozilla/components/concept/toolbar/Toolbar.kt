...
interface Toolbar : ScrollableToolbar {
     ...
     *
     * If the function returns `true` then the toolbar will automatically switch to "display mode". Otherwise it remains
     * in "edit mode".
     *
    ...
    /**
     * Removes a previously added browser action (see [addBrowserAction]). If the the provided actions was never added,
    ...
    /**
     * Removes a previously added page action (see [addBrowserAction]). If the the provided actions was never added,
     * this method has no effect.
     *
     * @param action the action to remove.
     */
    ...
    /**
     * Removes a previously added navigation action (see [addNavigationAction]). If the the provided actions was never
    ...
    /**
     * Switches to URL editing mode (from display mode) if supported by the toolbar implementation, and focuses the URL
     * input field based on the cursor selection.
     *
     ...
     *
     * @param imageDrawable The drawable to be shown.
     * @param contentDescription Optional content description to be used. If no content description is provided then
     *   this view will be treated as not important for accessibility.
     * @param padding A optional custom padding.
     */
    open class ActionImage(
        ...
        override fun createView(parent: ViewGroup): View =
            AppCompatImageView(parent.context).also { image ->
                ...
                image.importantForAccessibility =
