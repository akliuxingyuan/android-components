...
/**
 * Object providing autocomplete suggestions for the toolbar. More such objects can be set for the same toolbar with
 * each getting results from a different source. If more providers are used the [autocompletePriority] property allows
 * to easily set an order for the results and the suggestion of which provider should be tried to be applied first.
 */
